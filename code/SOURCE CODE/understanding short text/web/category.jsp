...
System.out.println("Short text="+name);
                    try {
                        ...
                        rs = st.executeQuery("select DISTINCT sname from image where name LIKE'%"+name+"%' OR sname LIKE'%"+name+"%'  ");
                        while (rs.next()) {
...
%>
            ...
            <tr>
                ...
                <td><a href="names.jsp?name=<%=rs.getString("sname")%>"> Click TO Search</a></td>
...
String names = request.getParameter("name");
                    ...
                    Statement stt = null;
                    ResultSet rss = null;
System.out.println("Short text="+names);
                    try {
                        con = DbConnection.getConnection();
                        st = con.createStatement();
                        rs = st.executeQuery("select DISTINCT sname from file where sname LIKE '%"+names+"%' OR filename  LIKE '%"+names+"%'");
                        while (rs.next()) {
