...
<center><h3 style="color: white">TOPK RANK FILES </h3></center><br><br><br>
...
System.out.println("Short text="+names);
                    try {
                        ...
                        rs = st.executeQuery("select *from file ORDER BY rank DESC");
                        while (rs.next()) {
 ...
 <div class="sidebar one_quarter first"> 
      ...
      <nav>
        <ul>
          ...
          <li><a href="#" style="color: white;font-size: 18px">TopK Files</a></li>         
