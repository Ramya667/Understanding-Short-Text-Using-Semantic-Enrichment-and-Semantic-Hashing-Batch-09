...
<center><h3 style="color: white">ADMIN LOGIN</h3></center><br><br><br>
<center><div id="comments">
        <img style="float: right;margin-right: 100px" src="images/demo/login.jpg" alt="filler image">
     <form action="alog1.jsp" method="post">
            &nbsp;&nbsp;<div class="one_third ">
            <label style="color: white">User Name <span>*</span></label>
