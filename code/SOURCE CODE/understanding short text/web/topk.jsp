...
<center><h3 style="color: white">TOPK RANK </h3></center><br><br><br>
<center><h3 style="color: white">TOPK IMAGES </h3></center><br><br><br>
...
%>
            ...
            <tr>
                ...
                <td style="width: 300px;height: 200px"><img width="100px" height="100px" src="viewimg1.jsp?id=<%=rs.getString("id")%>"/></td>
 ...
 <div class="sidebar one_quarter first"> 
      ...
      <nav>
        <ul>
          ...
          <li><a href="topkfile.jsp" style="color: white;font-size: 18px">TopK File</a></li>         
