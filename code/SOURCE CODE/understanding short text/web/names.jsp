...
System.out.println("Short text="+name);
                    try {
                        ...
                        rs = st.executeQuery("select * from image where sname='"+name+"' ");
                        while (rs.next()) {
...
%> 
            ...
            <tr>
                ...
                <td><a href="rank1.jsp?result=<%=rs.getString("id")%>"> Click TO Search</a></td>
...
System.out.println("Short text="+names);
                    try {
                        con = DbConnection.getConnection();
                        st = con.createStatement();
                        rs = st.executeQuery("select * from file where sname='"+names+"' ");
                        while (rs.next()) {
...
%>
            ...
            <tr>
                ...
                <td><a href="rank.jsp?result=<%=rs.getString("id")%>"> Click TO Search</a></td>
