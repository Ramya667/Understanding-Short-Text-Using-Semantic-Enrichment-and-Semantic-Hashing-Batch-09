...
<center><h3 style="color: white">UPLOAD IMAGE</h3></center><br><br>
<div id="comments">
    <div style="float: right;margin-right: 100px">
        <form style="width: 700px" action="Upload" enctype="multipart/form-data" method="post">
            &nbsp;&nbsp;<div class="one_third ">
            <label style="color: white">Image Name <span>*</span></label>
          ...
          <div class="one_third">
        <lable style="color:white; font-size: 20px;width: 0px"> Image:</lable></td>
