...
<center><h5 style="color: white">RESULTS FOR FILES </h5></center><br><br>
...
<%
String ids=(String)session.getAttribute("result");
                     Connection con = null;  
                    Statement st = null;
                    ResultSet rs = null;
System.out.println("Short text="+ids);
                    try {
                        con = DbConnection.getConnection();
                        st = con.createStatement();
                        rs = st.executeQuery("select * from file where id='"+ids+"' ");
                        while (rs.next()) {
...
%>
            ...
            <tr>
                <td style="width: 200px"><label style="color: black">File Name <span>*</span></label></td>
                <td style="width: 300px"><%=rs.getString("filename")%></td>
            </tr>
            <tr>
                <td><label style="color: black">File Subname <span>*</span></label></td>
            ...
            <tr>
                <td><label style="color: black">File<span>*</span></label></td>
               <td style="height: 200px" name="file" id="comment"><%=rs.getString("file")%></</td>
            </tr>
            <tr>
            <td><label>Rank <span>*</span></label></td>
