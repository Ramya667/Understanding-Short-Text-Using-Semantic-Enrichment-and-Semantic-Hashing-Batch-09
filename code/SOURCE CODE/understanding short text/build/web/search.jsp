...
<center><h3 style="color: white">SEARCH SHORT TEXT QUERY </h3></center><br><br><br>
<div id="comments" style="float: right;margin-right: 100px">
        <form style="width: 700px" action="category.jsp" method="get">
            &nbsp;&nbsp;<div class="one_third ">
            <label style="color: white">Search Query<span>*</span></label>
            <input  style="width: 400px" type="text" name="name" id="name" placeholder="Enter Short Text" size="22" required>
          </div><br><br><br><br>
          <div class="">
